...
In the next sprint, I would like to implement the Java that I have learned and get to use springboot, rather than simply working on frontend features like Frontend Quest. This will help me expand on my programming knowledge and better prepare for the AP Exam. 
